...
@Component("mockSaldoTaeClient")
public class MockSolicitudSaldoTaeClient {
	...
	public void startConnection(String ip, int port) {
		try {
			System.out.println("abriendo cleinte Tae con: " + ip + ":" + port);
	...
	public String sendMessage(String msg) {
		String resp = "";
		try {
			System.out.println("enviando mensaje tae: " + msg);
			out.println(msg);
			// out.flush();
			resp = in.readLine();
		} catch (IOException ex) {
	...
	public void stopConnection() {
		try {
			...
			Logger.getLogger(MockSolicitudSaldoTaeClient.class.getName()).log(Level.SEVERE, null, ex);
		}
