...
@Component("mockSaldoVsClient")
public class MockSolicitudSaldoVsClient {
	...
	public void startConnection(String ip, int port) {
		try {
			System.out.println("abriendo cleinte Vs con: " + ip + ":" + port);
	...
	public String sendMessage(String msg) {
		String resp = "";
		try {
			System.out.println("enviando mensaje Vs: " + msg);
			out.println(msg);
			// out.flush();
			resp = in.readLine();
		} catch (IOException ex) {
	...
	public void stopConnection() {
		try {
			...
			Logger.getLogger(MockSolicitudSaldoVsClient.class.getName()).log(Level.SEVERE, null, ex);
		}
